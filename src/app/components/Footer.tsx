...
export default function Header() {
  return (
    <td>
      ...
      <br />
      <center>
        <a href="https://news.ycombinator.com">Applications are open for YC Summer 2023</a>
      </center>
      <br />
      <center>
        <span className="yclinks">
          ...
          <a href="https://www.ycombinator.com/apply/">Apply to YC</a> |<a href="mailto:hn@ycombinator.com">Contact</a>
        </span>
        <br />
        <br />
